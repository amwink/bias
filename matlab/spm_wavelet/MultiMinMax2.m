...
for j=J-1:-1:L
    ...
    ws(dyad(j),dyad(j))=HardThreshAbs(ws(dyad(j),dyad(j)),lam);
    ws(bdyad(j),dyad(j))=HardThreshAbs(ws(bdyad(j),dyad(j)),lam);
    ws(dyad(j),bdyad(j))=HardThreshAbs(ws(dyad(j),bdyad(j)),lam);
end;
