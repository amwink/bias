...
for j=(J-1):-1:L
    ...
    ws(dyad(j),dyad(j))=reshape(JamesStein(tws(:)'),l,l);
    tws=ws(bdyad(j),dyad(j));
    ws(bdyad(j),dyad(j))=reshape(JamesStein(tws(:)'),l,l);
    tws=ws(dyad(j),bdyad(j));
    ws(dyad(j),bdyad(j))=reshape(JamesStein(tws(:)'),l,l);
end
