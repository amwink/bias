...
h.fr = uicontrol (fegui, ...
		  ...
		  'tag','thefilesclear', ...
		  'horizontalalignment','left', ...
		  'tooltipstring','clear the current selection of files', ...
		  'position',[.25 .61 .2 .05]);
...
h.rc = uicontrol (fegui, ...
		  ...
		  'horizontalalignment','left', ...
		  'backgroundcolor',[.8 .8 .8], ...
		  'tooltipstring','produce fECM rank maps, whose values are uniformly distributed on ]0,1[', ...
		  'position',[.6 .7 .15 .05]);
...
h.nc = uicontrol (fegui, ...
		  ...
		  'horizontalalignment','left', ...
		  'backgroundcolor',[.8 .8 .8], ...
		  'tooltipstring','produce fECM maps with N(0,1) distributed values, computed via fECM ranks', ...
		  'position',[.8 .7 .15 .05]);
...
h.ic = uicontrol (fegui, ...
		  ...
		  'horizontalalignment','left', ...
		  'backgroundcolor',[.8 .8 .8], ...
		  'tooltipstring','set the maximum number of iterations for the fECM algorithm', ...
		  'position',[.8 .6 .15 .05]);
...
set(h.fr,'callback',{@clearfiles,h})
...
[fnames,dname] = uigetfile(exts, 'select file(s) to open', ...
			   'multiselect','on');
...
function clearfiles(callingObject,event,h);
